 ...
 * Known implementing classes: {@link CertificateManagerImpl}, {@link LocalCertificateManager}
...
public interface CertificateManager extends UnambiguityPovider<BigInteger> {
	...
	/**
	 * Loads the certificate with the given serial number from a persistent source and returns it.
	 * @param serialNumber The serial number of the certificate to load.
	 * @return The loaded certificate or {@code null} if there is no certificate with the given serial number.
	 */
	 ...
	 * @param andRevoke {@code true} if the removed certificate should be marked and published as revoked.
	 */
