...
public class CRLVerifier {
     ...
     * @param crlURL The url to search.
     * @return The loaded CRL.
     * @throws IOException if an I/O error occurs.
     * @throws CertificateException If there was an error regarding the certificate.
     * @throws CRLException If there was an error regarding the CRL to download.
     * @throws CertificateVerificationException If the CRL could not be loaded.
     * @throws NamingException If a name could not be resolved.
     */
     ...
     * @param ldapURL The URL to search for a CRL.
     * @return The loaded CRL.
     * @throws CertificateException If there was an error regarding the certificate.
     * @throws CRLException If there was an error regarding the CRL to download.
     * @throws CertificateVerificationException If the CRL could not be loaded.
     ...
     * @param crlURL The URL to search for a CRL.
     * @return The loaded CRL.
     * @throws IOException if an I/O error occurs.
     * @throws CertificateException If there was an error regarding the certificate.
     * @throws CRLException If there was an error regarding the CRL to download.
     ...
     * @param cert The certificate thats CRL distribution points should be returned.
     * @return A list of all CRL distribution point URLs obtained from the given certificate.
     * @throws CertificateParsingException If there was an error reading from the certificate.
     * @throws IOException If an I/O error occurs.
     */
    public static List<String> getCrlDistributionPoints(
        ...
        byte[] crldpExt = cert.getExtensionValue(
        		org.bouncycastle.asn1.x509.Extension.cRLDistributionPoints.getId());
        if (crldpExt == null) {
