...
public class CertificateVerifier {
	 ...
	 * @throws CertificateException If there was an error accessing the certificate.
	 * @throws NoSuchAlgorithmException If there is no implementation of the used algorithm.
	 * @throws NoSuchProviderException If the security provider (BC) was not found.
	 * @return {@code true} if the given certificate is self signed.
	 */
